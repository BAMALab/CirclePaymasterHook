...
contract DeployHookScript is BaseScript {
    ...
    address constant SEPOLIA_CIRCLE_PAYMASTER_INTEGRATION =
        0x194CC08EFeD09BE41E94b9Bb4c5Aa265662B428e; // formal address 0x3BA9A96eE3eFf3A69E2B18886AcF52027EFF8966;
    function run() public {
        ...
        vm.startBroadcast();
        CirclePaymasterHook circlePaymasterHook = new CirclePaymasterHook{
            salt: salt
        }(
            poolManager,
            payable(SEPOLIA_CIRCLE_PAYMASTER_INTEGRATION),
        ...
        require(
            address(circlePaymasterHook) == hookAddress,
